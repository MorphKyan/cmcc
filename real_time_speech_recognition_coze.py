...
# Coze API Token, Bot ID and User ID
COZE_API_TOKEN = "pat_NFMUbYZmlVVeNDdjKBgaygfGSDIqsfgiVXBPRvdyj5v5LlGfTgJtTk2Di1NLU1Dw"
COZE_API_BASE = COZE_CN_BASE_URL
# 请在这里替换为你的Bot ID
COZE_BOT_ID = "7533631841875099690"
# The user id identifies the identity of a user.
USER_ID = '123456789'


def get_coze_response(query: str) -> str:
    """
    调用Coze API获取模型响应, 并流式打印到控制台
    ...
    Returns:
        str: 模型输出的完整文本
    """
    if COZE_BOT_ID == "YOUR_BOT_ID_HERE":
        warning = "[警告] 请在脚本中设置您的COZE_BOT_ID"
        print(warning)
        return warning
    ...
    try:
        ...
        for event in coze.chat.stream(
            ...
            if event.event == ChatEventType.CONVERSATION_MESSAGE_DELTA:
                ...
                error_message = f"\n[错误] Coze API 调用失败: {event.error.message}"
                print(error_message)
